...
public static class UserHasDataConfiguration
{
    ...
    public static IEnumerable<User> Users()
    {
        return new List<User>()
        {
            ...
            new User { Id = 3L, Name = "김", Age=22, Email="김@email.com", IsPremium = true },
            new User { Id = 4L, Name = "이", Age=23, Email="이@email.com", IsPremium = true },
            new User { Id = 5L, Name = "도", Age=24, Email="도@email.com", IsPremium = true },
